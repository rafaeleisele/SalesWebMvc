...
namespace SalesWebMvc.Data
{
    public class SalesWebMvcContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            Seller s3 = new Seller(3, "Alex Grey", "Alex@gmail.com", new DateTime(1997, 2, 28), 1000.0, d1);
            Seller s4 = new Seller(4, "Martha Red", "Martha@gmail.com", new DateTime(1989, 10, 10), 2500.0, d4);
            Seller s5 = new Seller(5, "Pedro Yellow", "Pedro@gmail.com", new DateTime(1985, 8, 6), 3000.0, d3);
            Seller s6 = new Seller(6, "Peter Blue", "Peter@gmail.com", new DateTime(1990, 5, 2), 4000.0, d2);
            ...
            modelBuilder.Entity<SalesRecord>().HasData(new[] {
